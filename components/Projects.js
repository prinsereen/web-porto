        ...
        <div className="row gap-50">
          ...
          <div className="col-md-6">
            <div className="project-item style-four wow fadeInUp delay-0-2s">
              <div className="image">
                <img
                  src="assets/images/projects/project-two2.png"
                  alt="Project"
                />
                <Link legacyBehavior href="https://arundemy.prinserenn.my.id">
                  <a className="hover-box">
                    <span>View More</span>
                    <i className="far fa-arrow-up" />
                  </a>
          ...
          <div className="col-md-6">
            <div className="project-item style-four wow fadeInUp delay-0-2s">
              <div className="image">
                <img
                  src="assets/images/projects/project-two3.png"
                  alt="Project"
                />
                <Link legacyBehavior href="https://bersamaberanjak.prinserenn.my.id">
                  <a className="hover-box">
                    <span>View More</span>
                    <i className="far fa-arrow-up" />
                  </a>
              ...
              <div className="content">
                <h5 className="title">
                  <Link legacyBehavior href="https://bersamaberanjak.prinserenn.my.id">
                    <a>Landing Page Bersama Beranjak</a>
                  </Link>
                </h5>
          ...
          <div className="col-md-6 order-md-3">
            <div className="project-item style-four wow fadeInUp delay-0-2s">
              <div className="image">
                <img
                  src="assets/images/projects/project-two5.png"
                  alt="Project"
                />
                <Link legacyBehavior href="https://openlayers.prinserenn.my.id">
                  <a className="hover-box">
                    <span>View More</span>
                    <i className="far fa-arrow-up" />
                  </a>
