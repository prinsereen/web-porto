              ...
              <div className="resume-box wow fadeInLeft delay-0-2s">
                <div className="resume-column">
                  <div className="timeline-item">
                    <div className="resume-content">
                      <span className="duration">
                        <i className="far fa-calendar-alt" /> Jan 25 - Present{" "}
                      </span>
                      <h5 className="title">Full Stack Developer</h5>
                      <h6 className="sub-sub-tile">Bersama Beranjak</h6>
                    </div>
                  ...
                  <div className="timeline-item">
                    <div className="resume-content">
                      <span className="duration">
                        <i className="far fa-calendar-alt" /> Sep 24 - Des 24{" "}
                      </span>
                      <h5 className="title">Full Stack Developer</h5>
                      <h6 className="sub-sub-tile">Telkom Indonesia</h6>
                    </div>
                    <a href="#" className="details-btn">
                      <i className="fal fa-long-arrow-right" />
                    </a>
                ...
                <div className="resume-column">
                  <div className="timeline-item">
                    <div className="resume-content">
                      <span className="duration">
                        <i className="far fa-calendar-alt" /> Mar 24 - Sep 24{" "}
                      </span>
                      <h5 className="title">Full Stack Developer</h5>
                      <h6 className="sub-sub-tile">Arundemy</h6>                    
                      </div>
                    <a href="#" className="details-btn">
                      <i className="fal fa-long-arrow-right" />
                    </a>
                  ...
                  <div className="timeline-item">
                    <div className="resume-content">
                      <span className="duration">
                        <i className="far fa-calendar-alt" /> Okt 23 - Mar 23{" "}
                      </span>
                      <h5 className="title">Backend Developer</h5>
                      <h6 className="sub-sub-tile">Telkom Indonesia</h6> 
                      </div>
                    <a href="#" className="details-btn">
                      <i className="fal fa-long-arrow-right" />
                ...
                <div className="resume-column">
                  <div className="timeline-item">
                    <div className="resume-content">
                      ...
                      <h5 className="title">Undergraduate Informatics</h5>
                      <h6 className="sub-title">Telkom University</h6>
                    </div>
                    <a href="#" className="details-btn">
                      <i className="fal fa-long-arrow-right" />
                    </a>
                  ...
                  <div className="timeline-item">
                    <div className="resume-content">
                      <span className="duration">
                        <i className="far fa-calendar-alt" /> Des 24 - Present{" "}
                      </span>
                      <h5 className="title">DevOps Bootcmap</h5>
                      <h6 className="sub-title">DigitalSkola</h6>
                      </div>
                    <a href="#" className="details-btn">
                      <i className="fal fa-long-arrow-right" />
                    </a>
                ...
                <div className="resume-column">
                  <div className="timeline-item">
                    <div className="resume-content">
                      ...
                      <h5 className="title">Fullstack Bootcamp</h5>
                      <h6 className="sub-title">HariSenin</h6>
                    </div>
                    <a href="#" className="details-btn">
                      <i className="fal fa-long-arrow-right" />
                    </a>
                  ...
                  <div className="timeline-item">
                    <div className="resume-content">
                      ...
                      <h5 className="title">SMAN 1 Semarang</h5>
                    </div>
                    <a href="#" className="details-btn">
                      <i className="fal fa-long-arrow-right" />
                    </a>
