          ...
          <div className="col-lg-7">
            <div className="about-content-two rel z-2 rmb-55">
              ...
              <div className="text pb-5">
                Empowering your vision, one line of code at a time, by crafting innovative, scalable, and user-centric software solutions that bridge creativity and technology.
              </div>
              <div className="row">
              ...
              <div className="row gap-40 justify-content-center">
                ...
                <div className="col-lg-5 col-6">
                  <div className="counter-item counter-text-wrap wow fadeInDown delay-0-2s">
                    <Counter end={20} extraClass={""} />
                    <span className="counter-title">Award achievmentd</span>
                  </div>
                </div>
                <div className="col-lg-5 col-6">
                  <div className="counter-item counter-text-wrap wow fadeInDown delay-0-2s">
                    <Counter end={17} extraClass={""} />
                    <span className="counter-title">Tech Stack</span>
                  </div>
                </div>
              </div>
